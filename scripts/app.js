...
function() {
    ...
    angular.module("app").config(["$stateProvider", "$urlRouterProvider", function(e, t) {
        var a, n;
        a = ["ui/cards", "ui/typography", "ui/buttons", "ui/icons", "ui/grids", "ui/widgets", "ui/components", "ui/timeline", "ui/lists", "ui/pricing-tables", "map/maps", "table/static", "table/dynamic", "table/responsive", "form/elements", "form/layouts", "form/validation", "form/wizard", "chart/echarts", "chart/echarts-line", "chart/echarts-bar", "chart/echarts-pie", "chart/echarts-scatter", "chart/echarts-more", "page/404", "page/create", "page/change", "page/display",  "page/groupmon1", "page/groupmon2", "page/groupmon3", "page/groupmon4", "page/groupoverview", "page/settings" , "page/postmonitor", "page/wzcreate", "page/wzchange" , "page/wzdata", "page/madata", "page/macreate", "page/machange", "page/monitor", "page/500", "page/blank", "page/forgot-password", "page/invoice", "page/lock-screen", "page/profile", "page/signin", "page/signup", "app/calendar"], n = function(t) {
            var a, n;
            return n = "/" + t, a = {
                url: n,
...
function() {
    function e(e) {
        e.useStaticFilesLoader({
            prefix: "i18n/",
            suffix: ".json"
        }), e.preferredLanguage("de"), e.useSanitizeValueStrategy(null)
    }
    ...
    function t(e, t) {
        ...
        e.lang = "German", e.setLang = a, e.getFlag = n
    }
